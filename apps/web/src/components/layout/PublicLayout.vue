<template>
  <div class="min-h-screen flex flex-col bg-white">
        ...
        <div class="flex items-center justify-between h-16 gap-4">
          ...
          >
            <img
              v-if="config.logoUrl"
              :src="config.logoUrl"
              class="h-14 w-auto drop-shadow-md group-hover:drop-shadow-lg group-hover:scale-[1.04] transition-all duration-200"
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8 mb-10">
          ...
          <div>
            ...
            <a
              ...
              target="_blank"
              rel="noopener"
              class="inline-flex items-center gap-2 text-purple-300 hover:text-white text-sm
    ...
    <a
      ...
      :href="`https://wa.me/${config.socialLinks.whatsapp}?text=${encodeURIComponent('Olá! Vim pelo site e preciso de ajuda. 😊')}`"
      target="_blank"
      rel="noopener"
